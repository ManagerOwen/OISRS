...
urlpatterns = [
    ...
    # This is Tech Panel
    path('tecsignup/', tecviews.TECSIGNUP, name='tecsignup'),
...
if settings.DEBUG:
    urlpatterns += static(settings.MEDIA_URL, tecument_root=settings.MEDIA_ROOT)
    urlpatterns += static(settings.STATIC_URL, tecument_root=settings.STATIC_ROOT)

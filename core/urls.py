...
urlpatterns = [
    ...
    path('Admin/ViewCustomertDetails/<str:id>', adminviews.ViewCustomerDetails, name='viewcustomertdetails'),
    ...
    path('TechHireDetails/<str:id>', tecviews.Tech_Hire_Details, name='viewtechdetails'),
    path('HireDetailsRemark/Update', tecviews.Tech_Hire_Details_Remark, name='tech_hire_details_remark'),
    path('New', tecviews.Tech_New_Hire, name='technewhire'),
    path('Approved', tecviews.Tech_Approved_Hire, name='techapprovedhire'),
    path('Cancelled', tecviews.Tech_Cancelled_Hire, name='techcancelledhire'),
    path('AllHire', tecviews.Tech_All_Hire, name='techallhire'),
    path('Clients', tecviews.All_Clients, name='clientlist'),
    path('Completed', tecviews.Tech_Hire_Completed, name='completedhire'),
    path('TechHireList/<str:id>', tecviews.TechHireList, name='techhirelist'),
    path('TechHireDescription', tecviews.Tech_Hire_Description, name='techhiredescription'),

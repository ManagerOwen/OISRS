...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('tasapp', '0003_specialization_alter_customuser_user_type'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('specialization_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='tasapp.specialization')),
            ],
        ),
    ]
